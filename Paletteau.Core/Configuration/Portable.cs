...
namespace Paletteau.Core.Configuration
{
    public class Portable : IPortable
    {
        ...
        public void DisablePortableMode()
        {
            try
            {
                ...
                MessageBox.Show("Paletteau needs to restart to finish disabling portable mode, " +
        ...
        public void EnablePortableMode()
        {
            try
            {
                ...
                MessageBox.Show("Paletteau needs to restart to finish enabling portable mode, " +
        ...
        public void PreStartCleanUpAfterPortabilityUpdate()
        {
            ...
            var roamingDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Paletteau");
            ...
            if (DataLocationRoamingDeleteRequired)
            {
                ...
                if (MessageBox.Show("Paletteau has detected you enabled portable mode, " +
            ...
            if(DataLocationPortableDeleteRequired)
            {
                ...
                MessageBox.Show("Paletteau has detected you disabled portable mode, " +
        ...
        public bool CanUpdatePortability()
        {
            ...
            {
                MessageBox.Show(string.Format("Paletteau detected your user data exists both in {0} and " +
