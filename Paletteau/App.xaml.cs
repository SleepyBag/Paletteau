...
using Paletteau.Infrastructure.Http;
...
using Stopwatch = Paletteau.Infrastructure.Stopwatch;
    ...
    public partial class App : IDisposable, ISingleInstanceApp
    {
        ...
        private void OnStartup(object sender, StartupEventArgs e)
        {
            Logger.StopWatchNormal("Startup cost", () =>
            {
                ...
                Logger.WoxInfo("Begin Paletteau startup----------------------------------------------------");
                Settings.Initialize();
                ...
                Logger.WoxInfo("End Paletteau startup ----------------------------------------------------  ");

                API.ShowMsg($"Paletteau Started", $"Happy commanding!!!", "", false);
            });
        }
        ...
        public void Dispose()
        {
            Logger.WoxInfo("Paletteau Start Displose");
            ...
            Logger.WoxInfo("Paletteau End Displose");
        }
